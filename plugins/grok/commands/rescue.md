...
argument-hint: "[--background|--wait] [--resume|--fresh] [--model <model|composer>] [--effort <low|medium|high>] [what Grok should investigate, solve, or continue]"
...
- Leave the model unset unless the user explicitly asks for one. If they ask for `composer`, map it to `grok-composer-2.5-fast`.
